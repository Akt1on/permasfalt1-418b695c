...
function ServicePage() {
  ...
  const { data: service = staticService, isLoading } = useQuery({ queryKey: ["service", slug], queryFn: () => fetchService(slug), initialData: staticService, staleTime: Infinity, initialDataUpdatedAt: 0 });
