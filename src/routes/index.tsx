...
export const Route = createFileRoute("/")({ 
  ...
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "асфальтирование пермь, асфальтирование цена за м2, укладка тротуарной плитки пермь, благоустройство территорий, аренда спецтехники пермь, демонтаж пермь, щебень и песок с доставкой, вывоз снега и мусора, земляные работы пермский край, асфальтирование под ключ" },
    ...
    <>
      ...
      <section className="relative -mt-24 min-h-[100vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Асфальтирование" className="h-full w-full object-cover" width={1920} height={1080} loading="eager" fetchPriority="high" decoding="sync" />
